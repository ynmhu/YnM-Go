...
func NewMoviePlugin(bot *irc.Client, adminPlugin *admin.AdminPlugin, jellyfinDBPath, movieDBPath, requestsChannel, postTime, postChan, postNick string) *MoviePlugin {
	plugin := &MoviePlugin{
		bot:             bot,
